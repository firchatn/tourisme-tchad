...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Agences | Ajouter</h3>
  ...
  <div class="card-body">
    <form role="form" action="#" method="post" id="form">
      ...
      <div class="form-group">
        <label>Ville</label>
        <input type="text" name="ville" class="form-control" placeholder="Enter ...">
      </div>
      <div class="form-group">
        <label>Quartier</label>
        <input type="text" name="quartier" class="form-control" placeholder="Enter ...">
      </div>
    </form>
  </div>
