...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Comptes | Ajouter</h3>
  ...
  <div class="card-body">
    <form role="form" action="#" method="post" id="form">
      ...
      <div class="form-group">
        <label>Login</label>
        <input type="text" name="login" class="form-control" placeholder="Enter ...">
      </div>
      <div class="form-group">
        <label>Password</label>
        <input type="password" name="passwd" class="form-control" placeholder="Enter ...">
      </div>
    </form>
  </div>
