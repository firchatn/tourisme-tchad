...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Contacts | Modifier</h3>
  ...
  <div class="card-body">
    <form role="form" action="#" method="post" id="form">
      ...
      <div class="form-group">
        <label>Email</label>
        <input type="email" name="email" value="<?= $object['email'] ?>" class="form-control" placeholder="Enter ...">
      </div>
      <div class="form-group">
        <label>Message</label>
        <textarea name="message"class="form-control" placeholder="Enter ..."><?= $object['message']?></textarea>
      </div>
      <div class="form-group">
        <label>Tel</label>
        <input type="tel" name="tel" value="<?= $object['tel'] ?>" class="form-control" placeholder="Enter ...">
      </div>
      <div class="form-group">
        <label>Adresse</label>
        <input type="text" name="adresse" value="<?= $object['adresse'] ?>" class="form-control" placeholder="Enter ...">
      </div>
    </form>
  </div>
