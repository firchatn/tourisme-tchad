...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Hotels | Detail</h3>
  ...
  <div class="card-footer">
    <a href="<?= site_url($base .'/edit/'. $object['id_hotels'])?>" class="btn btn-primary float-right" form="form"><i class="fa fa-check"></i> Edit</a>
