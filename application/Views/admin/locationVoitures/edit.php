...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Locations Voitures | Modifier</h3>
  ...
  <div class="card-body">
    <form role="form" action="#" method="post" id="form">
      ...
      <div class="form-group">
        <label>Date</label>
        <input type="date" name="date" value="<?= $object['date'] ?>" class="form-control" placeholder="Enter ...">
      </div>
      <div class="form-group">
        <label>Prix</label>
        <input type="number" name="prix" value="<?= $object['prix'] ?>" class="form-control" placeholder="Enter ..." min="0">
      </div>
      <div class="form-group">
        <label>Marque</label>
        <input type="text" name="marque" value="<?= $object['marque'] ?>" class="form-control" placeholder="Enter ...">
      </div>
    </form>
  </div>
