...
<div class="card card-default">
  <div class="card-header">
    <h3 class="card-title">Offres Voyages | Detail</h3>
  ...
  <div class="card-body">
    <form role="form" action="#" method="post" id="form">
      ...
      <div class="form-group">
        ...
        <input type="text" name="description" value="<?= $object['description'] ?>" class="form-control" placeholder="Enter ..." readonly>
      </div>
    </form>
  </div>
  <div class="card-footer">
    <a href="<?= site_url($base .'/edit/'. $object['id_offrevoyages'])?>" class="btn btn-primary float-right" form="form"><i class="fa fa-check"></i> Edit</a>
